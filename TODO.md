...
- Land kernel fixes for v9fs/linux#3 (`tail -f` misses virtio server appends) and delete the `qemu-virtio none/readahead/mmap` lines from `expected/legacy.txt` (XPASS until then).
